...
class MoviesPage extends StatelessWidget {
  ...
  final itemHeight = ((Get.width - (12.0 * 3)) / 3.5) * (244 / 163);
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  buildUncategorizedVideoSegmentItem(latestTenMoviesUrl),
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 16.0),
  ...
  Widget buildBannerList() {
    return GetBuilder<MoviesPageController>(
      id: "section_banner",
      init: MoviesPageController(),
            ...
            if (snapshot.hasData) {
              ...
              if (finalBannerList.isNotEmpty) {
                return Container(
                  ...
                  child: Stack(
                    children: [
                      GetBuilder<MoviesPageController>(
                        id: "banner_view",
                        init: MoviesPageController(),
                        builder: (viewController) {
                      ...
                      Align(
                        ...
                        child: GetBuilder<MoviesPageController>(
                          init: MoviesPageController(),
                          builder: (viewController) {
                            return Padding(
  ...
  Widget buildDynamicVideoSegment() {
    ...
    return FutureBuilder<VideoCategoryListResponse>(
      future: Future.delayed(
        ...
        () => RemoteRepository.on().getMovieCategories(),
      ),
      builder: (context, snapshot) {
        if (snapshot.hasData) {
                        ...
                        Get.to(
                          ...
                          binding: MoreVideosPageBindings(
                            url: ApiUtil.appendPathIntoPostfix(
                              videosPageMoreMoviesByCategoryUrl,
                              videoCategory.type,
                            ),
                          ),
                        );
  ...
  bool _movieListNotificationListener(
    ...
    MoviesPageController viewController,
    String url,
  ) {
